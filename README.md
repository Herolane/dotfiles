...
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Herolane/dotfiles/mac/configure.sh)"
```

### WSL Configuration
Run the following to configure WSL from scratch...
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Herolane/dotfiles/wsl/configure.sh)"
```
